...
#dico = {'stars' : 0, 'time' : 1 , 'mag' : 13, 'err_mag' : 14,'exposure' : 15,'airmass' : 6,'frames':2,'seeing':17,'background':16,'CCD_X' :20,'CCD_Y' :21,'phot_scale_factor' : 18 }
